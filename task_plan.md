...
│   ┌────────────────┐                                         │ Conway API      │
│   │ 🔀 Layer 2     │                              ┌───────────┴─────────────┐   │
│   │ GitHub         │──── git pull (crontab) ────▶ │ ☁️ Layer 4              │   │
│   │ myfork/        │                              │ Cloud VPS (主权大脑)     │   │
...
| **Layer 3** | Cloud VPS | 🧠 **主权大脑** | 心跳守护、API 编排、构建、记忆持久化 |
| **Layer 4** | Conway Sandbox | 服务运行 | 可部署多个服务 (端口可变) |
...
| 问题 | 正确理解 |
|------|----------|
| VPS 的作用 | 🧠 **主权大脑** - 运行 auto_sync.sh、boot_loader.mjs |
| 代码拉取来源 | 从 `myfork` 拉取，不是 `origin/main` |
| 服务启动条件 | 平台 NORMAL + 资金 ≥ $10.00 |
| Sandbox 服务维护 | 由 VPS 上的 auto_sync.sh 触发
...
| 拉取来源 | 代码控制权 | 风险 |
|----------|-----------|------|
| `origin/main` | ❌ 官方控制 | 官方更新会覆盖你的功能 |
| `myfork/feat/...` | ✅ 你控制 | 只有你推送了才更新 |
...
| 版本 | 日期 | 主要变更 |
|------|------|----------|
| v1.7.0 | 2026-02-24 | 四层架构修正、自进化系统 v3.2、boot_loader.mjs、从 Fork 拉取机制 |
