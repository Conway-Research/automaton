...
const SENSITIVE_SUFFIX_PATTERNS = [
    ".key",
    ".pem",
];
 ...
 */
function createProtectedFilesRule() {
    return {
 ...
 */
function createReadSensitiveRule() {
    return {
 ...
 */
function createTraversalDetectionRule() {
    return {
...
export function createPathProtectionRules() {
    return [
