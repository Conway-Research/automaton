...
========================`;
        ...
        },
        {
            ...
            execute: async (args, ctx) => {
                ...
                const network = (args.network || "mainnet");
                const hash = await leaveFeedback(ctx.identity.account, args.agent_id, score, comment, network, ctx.db);
        ...
        },
        {
            ...
            execute: async (args, ctx) => {
                ...
                ctx.db.raw.prepare("UPDATE children SET funded_amount_cents = funded_amount_cents + ? WHERE id = ?").run(amount, child.id);
        ...
        },
        {
            ...
            execute: async (args, ctx) => {
                ...
                await ctx.conway.exec("automaton --init && automaton --provision && systemctl start automaton 2>/dev/null || automaton --run &", 60_000);
